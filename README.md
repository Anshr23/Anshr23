...
```bash
ansh@dev:~$ whoami
> Ansh Rai — Full-Stack Developer & SDE | Applied AI & Agentic Systems

ansh@dev:~$ education --list
> B.Tech in CSE @ MAIT, Delhi                  (2023 – 2027)
> Diploma in Programming @ IIT Madras           (Jan 2024 – Sep 2026)

ansh@dev:~$ background --experience
> DRDO                   · Research Intern (Formal Verification & Agent Control Flow)
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=ts,js,python,cpp,react,nextjs,nodejs,express,postgres,mongodb,redis,tailwind,git,postman" alt="Tech stack icons" />
</div>
